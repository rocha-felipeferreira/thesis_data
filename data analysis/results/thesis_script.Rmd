...
main_tokens <- tokens_replace(main_tokens, pattern = "fnanceira", replacement = "financeira", valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "fnanciamento", replacement = "financiamento", valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "id*ia", replacement = "ideia", valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("jedrzzej bielecki"), case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("s*rgio danese"),valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("correio bra*iliense"),valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("jeffrey jowell"),valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("
gilberto freyre"),valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "f*z*ram", replacement = "fizeram", valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "fzemos", replacement = "fizemos", valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "fscal", replacement = "fiscal", valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "primeiroministro", replacement = "primeiro ministro", valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("george* chi*oti"),valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("pascal lamy"),valuetype = "fixed", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("ru* barbosa"),valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("joaqu*m nabuco"),valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_replace(main_tokens, pattern = "*nica", replacement = "única", valuetype = "glob", case_insensitive = TRUE)

main_tokens <- tokens_compound(main_tokens, pattern = phrase("nicanor duarte"),valuetype = "fixed", case_insensitive = TRUE)
