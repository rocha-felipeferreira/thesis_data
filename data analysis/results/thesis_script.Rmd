...
mapa_pres$valor_cat <- cut(mapa_pres$value, breaks = c(0, 10, 50, 100, 200, 400, 600, 800, 10614), labels = c("0-10", "10-50", "50-100", "100-200", "200-400", "400-600", "600-800", "1000 ou mais"), include.lowest = TRUE)
...
mapa_mre$valor_cat <- cut(mapa_mre$value, breaks = c(0, 10, 50, 100, 200, 400, 600, 800, 10614), labels = c("0-10", "10-50", "50-100", "100-200", "200-400", "400-600", "600-800", "1000 ou mais"), include.lowest = TRUE)
...
agents_similarity <- dfm_trim(agents_similarity, min_termfreq = 5, min_docfreq = 3)
