...
ggplot(agents_ca_model_coefficients, aes(x = dim1, y=dim2)) + geom_label_repel(aes(label = rownames(agents_ca_model_coefficients))) + xlim(c(-2, 4)) + theme(panel.background = element_rect(fill = "white", colour = "black"), panel.grid.major = element_line(colour = "gray92"), axis.text = element_text(size = rel(1.1), colour = "black"))
