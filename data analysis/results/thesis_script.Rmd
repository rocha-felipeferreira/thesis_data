...
# ggsave("collocation_exec.png", proper_nouns_plot, height = 7.5, width = 11, dpi = 600)
...
# ggsave("real_exec_keyness.png", realm_keyness_exec_plot, height = 7, width = 10, dpi = 600)
