...
textplot_scale1d(agents_ca_model)
...
plot(1, xlim = c(-4, 4), ylim = c(-4, 4), type = 'n', xlab = 'Dimension 1', ylab = 'Dimension 2')
grid()
text(agents_ca_model_coefficients$dim1, agents_ca_model_coefficients$dim2, labels = rownames(dat_ca), cex = 0.8, col = rgb(0, 0, 0, 0.7))

ggplot(agents_ca_model_coefficients, aes(x = dim1, y=dim2)) + geom_label(aes(label = rownames(agents_ca_model_coefficients)))
